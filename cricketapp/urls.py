...
urlpatterns = [
    ...
    path('players/bulk-update/', views.PlayerBulkUpdateView.as_view(), name='player-bulk-update'),
    path('teams/bulk-update/', views.TeamBulkUpdateView.as_view(), name='team-bulk-update'),
    path('matches/bulk-update/', views.MatchBulkUpdateView.as_view(), name='match-bulk-update'),
    path('innings/bulk-update/', views.InningBulkUpdateView.as_view(), name='inning-bulk-update'),
    path('scores/batting/bulk-update/', views.BattingScoreBulkUpdateView.as_view(), name='batting-score-bulk-update'),
    path('scores/bowling/bulk-update/', views.BowlingScoreBulkUpdateView.as_view(), name='bowling-score-bulk-update'),
    path('scores/fow/bulk-update/', views.FallOfWicketBulkUpdateView.as_view(), name='fow-bulk-update'),
    path('scores/extras/bulk-update/', views.ExtrasBulkUpdateView.as_view(), name='extras-bulk-update'),
